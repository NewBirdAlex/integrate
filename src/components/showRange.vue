        ...
        <div class="department" v-if="showDepartment">
            ...
            <ul class="bgWhite ">
                <li v-for="(item,index) in list" :key="index">
                    {{item.name}}
                    <span class="fr" @click="item.ticket=!item.ticket"><i class="icon iconfont icon-gouxuan blue"  v-if="item.ticket"></i></span>
                </li>
                <li>
                    <span class="" @click="chooseAll"><i class="icon iconfont icon-gouxuan blue" v-if="selectAll" ></i></span>
                    全选
                    <small class="gray">
                        （不选择默认为单选）
                    </small>
